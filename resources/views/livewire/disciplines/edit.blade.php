    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-primary">
                <!-- form start -->
                <form wire:submit="updateDisciplineDetails" action="">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <button type="submit" class="btn btn-success float-right">
                            <span wire:loading wire:target="updateDisciplineDetails"><i class="fas fa-1x fa-sync-alt fa-spin"></i> Submitting...</span>
                            <span wire:loading.remove wire:target="updateDisciplineDetails">Submit</span> 
                        </button>
                    </div>
                </form>
              </div>
