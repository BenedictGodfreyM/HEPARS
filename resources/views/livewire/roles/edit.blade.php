...
<div>
    <div class="card card-primary">
        <!-- form start -->
        <form wire:submit="updateRoleDetails" action="">
            <div class="card-body">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-success float-right">
                    <span wire:loading wire:target="updateRoleDetails"><i class="fas fa-1x fa-sync-alt fa-spin"></i> Submitting...</span>
                    <span wire:loading.remove wire:target="updateRoleDetails">Submit</span>
                </button>
            </div>
        </form>
    </div>
