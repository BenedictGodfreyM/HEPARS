                                ...
                                <thead>
                                    <tr>
                                        @foreach ($columns as $column)
                                            <th @if($column != "compulsory" && $column != "additional") wire:click="sortBy('{{ $column }}')" @endif style="cursor: pointer;">
                                                {{ ucfirst($column) }}
                                                @if($column != "compulsory" && $column != "additional")
                                                    @if ($sortField === $column)
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Register High School Subjects</h4>
                                ...
                                <div class="modal-body card-comments">
                                    @livewire('subjects.register', key("asdfghjkl12345"))
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade show" id="modal-lg" style="display: block; padding-right: 15px;" aria-modal="true" role="dialog">
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body card-comments">
                                    @livewire('subjects.edit', ['subject_id' => $selectedRecord_SubjectID], key($selectedRecord_SubjectID))
                                </div>
                            </div>
                        </div>
                    </div>
