    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-primary">
                <!-- form start -->
                <form wire:submit="updateCombinationDetails" action="">
                    <div class="card-body">
                        ...
                        <div class="form-group" wire:ignore>
                            ...
                            <select class="select2-subjects select2-hidden-accessible form-control @error('selectedSubjects') is-invalid @enderror" multiple="" data-placeholder="Select Subjects" id="inputCombinationSubjects" style="width: 100%;" wire:model="selectedSubjects">
                                ...
                                <option data-select2-id="{{ $subject->id }}" value="{{ $subject->id }}" style="color: black;">{{ $subject->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="card-footer">
                        ...
                        <button type="submit" class="btn btn-success float-right">
                            <span wire:loading wire:target="updateCombinationDetails"><i class="fas fa-1x fa-sync-alt fa-spin"></i> Submitting...</span>
                            <span wire:loading.remove wire:target="updateCombinationDetails">Submit</span> 
                        </button>
                    </div>
                </form>
              </div>
