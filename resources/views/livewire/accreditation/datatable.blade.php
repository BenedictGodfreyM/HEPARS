                ...
                <div class="card-body">
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Accreditation Status Details</h4>
                                ...
                                <div class="modal-body card-comments">
                                    @livewire('accreditation.view', ['accreditation_id' => $selectedRecord_AccreditationID], key($selectedRecord_AccreditationID))
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade show" id="modal-lg" style="display: block; padding-right: 15px;" aria-modal="true" role="dialog">
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Register Accreditation Status</h4>
                                    <button type="button" wire:click="closeCreatorModel" class="close" data-dismiss="modal" aria-label="Close">
                                        <i class="fa fa-times" aria-hidden="true"></i>
                                    </button>
                                </div>
                                <div class="modal-body card-comments">
                                    @livewire('accreditation.register', key("asdfghjkl12345678"))
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade show" id="modal-lg" style="display: block; padding-right: 15px;" aria-modal="true" role="dialog">
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Update Accreditation Status Details</h4>
                                    <button type="button" wire:click="closeEditorModel" class="close" data-dismiss="modal" aria-label="Close">
                                        <i class="fa fa-times" aria-hidden="true"></i>
                                    </button>
                                </div>
                                <div class="modal-body card-comments">
                                    @livewire('accreditation.edit', ['accreditation_id' => $selectedRecord_AccreditationID], key($selectedRecord_AccreditationID))
                                </div>
                            </div>
                        </div>
                    </div>
