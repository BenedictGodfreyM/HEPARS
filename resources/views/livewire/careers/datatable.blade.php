                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Register Careers in {{ ucwords(strtolower($field->name)) }}</h4>
                                ...
                                <div class="modal-body card-comments">
                                    @livewire('careers.register', ['field_id' => $selectedRecord_FieldID], key($selectedRecord_FieldID))
                                </div>
                            </div>
                        </div>
                    </div>
