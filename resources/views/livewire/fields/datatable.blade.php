        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Registered Career Fields</h3>
                ...
                <div class="card-body">
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Register Fields</h4>
                                ...
                                <div class="modal-body card-comments">
                                    @livewire('fields.register', key("asdfghjkl12345"))
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade show" id="modal-lg" style="display: block; padding-right: 15px;" aria-modal="true" role="dialog">
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Update Field Details</h4>
                                    <button type="button" wire:click="closeEditorModel" class="close" data-dismiss="modal" aria-label="Close">
                                        <i class="fa fa-times" aria-hidden="true"></i>
                                    </button>
                                </div>
                                <div class="modal-body card-comments">
                                    @livewire('fields.edit', ['field_id' => $selectedRecord_FieldID], key($selectedRecord_FieldID))
                                </div>
                            </div>
                        </div>
                    </div>
