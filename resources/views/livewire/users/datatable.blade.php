                                            ...
                                            <tr wire:key="{{ $item->id }}">
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-primary btn-sm" wire:click="openEditorModal('{{ $item->id }}')">
                                                        ...
                                                        <span wire:loading.remove wire:target="openEditorModal('{{ $item->id }}')">Assign Roles</span>
                                                    </button>
                                                    @endpermission
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body card-comments">
                                    @livewire('users.view', ['user_id' => $selectedRecord_UserID], key($selectedRecord_UserID))
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade show" id="modal-lg" style="display: block; padding-right: 15px;" aria-modal="true" role="dialog">
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body card-comments">
                                    @livewire('users.edit', ['user_id' => $selectedRecord_UserID], key($selectedRecord_UserID))
                                </div>
                            </div>
                        </div>
                    </div>
